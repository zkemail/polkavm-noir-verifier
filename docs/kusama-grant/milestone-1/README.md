...
| 4 | Gas Optimization & Benchmark Report | Optimization work reducing verification and deployment gas costs, plus a published, reproducible benchmark report comparing PolkaVM, REVM, and EVM mainnet costs. | 160 | Optimization work documented: 5 real commits with same-day before/after Paseo measurements (modexp inversion, Montgomery constants, allocator swap, keccak host function, sumcheck for-loop), reaching REVM parity. Comparative benchmark (PolkaVM vs. REVM vs. EVM mainnet, measured fresh) still pending. **Proof:** [`04_gas_optimization_benchmark_report.md`](./04_gas_optimization_benchmark_report.md). |
...
- [`04_gas_optimization_benchmark_report.md`](./04_gas_optimization_benchmark_report.md) - optimization work with real before/after Paseo measurements (comparative benchmark section pending).
